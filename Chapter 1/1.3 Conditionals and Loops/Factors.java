...
public class Factors {
    ...
    public static void main(String[] args) {
        // convert input arguemnt into a long integer
        long n = Long.parseLong(args[0]);

        System.out.println("The prime factors of " + n);

        //initialize factor starting at 2
        int factor = 1;

        int count = 1; // A way to count the while loops
        ...
        while (n > 1) {
            ...
            if ((n % factor == 0) && factor > 1) {
                ...
                // Increment the number by the prime factor
                factor++;
            }
            if (n == 1) break; %
        ...
        System.out.println(count + " iterations of the main loop");
    }
}
